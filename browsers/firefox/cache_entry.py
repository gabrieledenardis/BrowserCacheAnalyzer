...
class CacheEntry(object):
    ...
    def __init__(self, entries_path=None, url_hash=None, frecency=None, expire_date=None, app_id=None, flags=None,
                 file_size=None):
        ...
        :param frecency: frecency parameter (frequency and recency)
        :param expire_date: expiration date
        :param app_id: app_id
        :param flags: flags
