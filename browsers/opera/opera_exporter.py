...
class OperaExporter(QtCore.QObject):
    """Exporter for Opera cache.
    """
    ...
    def exporter(self):
        ...
        opera_index_header = index_header_reader.read_index_header(index_file=opera_index_file)
...
##########################
        ...
        """.format(
            ...
            sha1=opera_index_info['file_sha1'],
            dimension=opera_index_info['file_dimension'],
            os_creation_time=opera_index_info['file_creation_time'],
            os_last_modified_time=opera_index_info['file_last_modified_time'],
            os_last_access_time=opera_index_info['file_last_access_time']
        )
        ...
        for data_file in os.listdir(self.input_path):
            if "data_" in data_file:
                ...
                opera_data_header = data_header_reader.read_data_header(data_to_open=data_file_path)
                ...
                """.format(
                    ...
                    next_file_number=opera_data_header['next_file_number'],
                    block_size=opera_data_header['block_size'],
                    num_entries=opera_data_header['num_entries'],
                    max_num_entries=opera_data_header['max_num_entries'],
                    md5=opera_data_info['file_md5'],
                    sha1=opera_data_info['file_sha1'],
                    dimension=opera_data_info['file_dimension'],
                    os_creation_time=opera_data_info['file_creation_time'],
                    os_last_modified_time=opera_data_info['file_last_modified_time'],
                    os_last_access_time=opera_data_info['file_last_access_time']
                )
        ...
        for sep_file in os.listdir(self.input_path):
            if "f_" in sep_file:
                ...
                """.format(
                    f_file=sep_file,
                    dimension=opera_f_info['file_dimension'],
                    os_creation_time=opera_f_info['file_creation_time'],
                    os_last_modified_time=opera_f_info['file_last_modified_time'],
                    os_last_access_time=opera_f_info['file_last_access_time'],
                    md5=opera_f_info['file_md5'],
